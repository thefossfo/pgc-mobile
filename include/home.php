...
$page_html .= '<div id="header"><img alt="PGC logo" src="images/pgc_ai.png">&nbsp;Personal Ground Control</div>';
...
$page_html .= '&nbsp;Please be advised that Personal Ground Control (PGC) is currently in its beta phase. As such, not all intended features and functionalities are fully operational. Users may also encounter data inconsistencies. We are actively working to finalize development and deliver a comprehensive and accurate product.';
$page_html .= '</div>';
**/
...
$page_html .=	'&nbsp;Personal Ground Control (PGC), is a project under <img alt="FOSSFO" style="height:1em;" src="images/fossfo-white.png" />, the Free & Open Source Spaceflight Organization. You can check them out <a class="white-link" href="https://fossfo.org/">here</a>.';
$page_html .= '</div>';
$page_html .= '<div id="footer-spacer"></div>';
$page_html .= '<script src="js/home.js"></script>';
$page_html .= '<script src="js/launch_item.js"></script>';
