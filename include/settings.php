...
$page_html .= '<div id="header"><img src="images/pgc_ai.png">&nbsp;PGC - Settings</div>';
...
$page_html .= '&nbsp;We respect your privacy. This website does not intentionally gather any personal information or camera data. Standard website usage is automatically recorded.';
$page_html .= '</div>';
